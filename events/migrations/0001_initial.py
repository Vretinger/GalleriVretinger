    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layout', models.CharField(choices=[('layout1', 'Layout 1 - Image left, text right'), ('layout2', 'Layout 2 - Text over image'), ('layout3', 'Layout 3 - Image grid')], default='layout1', max_length=20)),
